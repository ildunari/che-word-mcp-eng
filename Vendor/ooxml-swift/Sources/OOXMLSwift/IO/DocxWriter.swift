...
public struct DocxWriter {
    ...
    public static func write(_ document: WordDocument, to url: URL) throws {
        ...
        try writeSettings(document: document, to: tempDir)
    ...
    private static func writeSettings(document: WordDocument, to baseURL: URL) throws {
        var xml = """
        <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
        <w:settings xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
        """

        if document.revisions.settings.enabled {
            xml += """
            <w:trackRevisions/>
            """
        }
