...
import Logging
    ...
    public actor NetworkTransport: Transport {
        ...
        public func send(_ message: Data) async throws {
            ...
            // Use a lock-protected reference so Swift 6 can safely capture the state in async callbacks.
            let sendContinuationResumed = ContinuationResumeState()
            ...
            try await withCheckedThrowingContinuation {
                ...
                connection.send(
                    ...
                    completion: .contentProcessed { [weak self] error in
                        ...
                        Task { @MainActor in
                            if sendContinuationResumed.claim() {
                                if let error = error {
        ...
        private func receiveData() async throws -> Data {
            let receiveContinuationResumed = ContinuationResumeState()
            ...
            return try await withCheckedThrowingContinuation {
                ...
                connection.receive(minimumIncompleteLength: 1, maximumLength: maxLength) {
                    ...
                    Task { @MainActor in
                        if receiveContinuationResumed.claim() {
                            if let error = error {
